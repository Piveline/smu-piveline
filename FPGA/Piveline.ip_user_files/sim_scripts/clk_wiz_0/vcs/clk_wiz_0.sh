...
#
# Script generated by Vivado on Mon Mar 23 19:47:44 KST 2026
...
# script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../Piveline.gen/sources_1/ip/clk_wiz_0" \
  "/tools/Xilinx/2025.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \
  2>&1 | tee compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../Piveline.gen/sources_1/ip/clk_wiz_0" \
