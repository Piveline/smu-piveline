...
#
# Script generated by Vivado on Mon Mar 23 19:48:43 KST 2026
...
#
# Usage        : rgb2dvi_0.sh
#                rgb2dvi_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rgb2dvi_0.sh [-rerun]
#                rgb2dvi_0.sh [-reset_run]
#                rgb2dvi_0.sh [-clean]
#                rgb2dvi_0.sh [-reset_log]
#                rgb2dvi_0.sh [-help]
#
...
#                script (type 'rgb2dvi_0.sh -help' for more information).
#
...
# script info
echo -e "rgb2dvi_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rgb2dvi_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  "/tools/Xilinx/2025.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \
  2>&1 | tee compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rgb2dvi_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rgb2dvi_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rgb2dvi_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: rgb2dvi_0.sh [-step]\n\
Usage: rgb2dvi_0.sh [-lib_map_path]\n\
Usage: rgb2dvi_0.sh [-rerun]\n\
Usage: rgb2dvi_0.sh [-reset_run]\n\
Usage: rgb2dvi_0.sh [-clean]\n\
Usage: rgb2dvi_0.sh [-reset_log]\n\
Usage: rgb2dvi_0.sh [-keep_index]\n\
